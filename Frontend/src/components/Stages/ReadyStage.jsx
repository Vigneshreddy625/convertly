...
export default function ReadyStage({ onStartOver }) {
    return (
      <div className="bg-gray-100 dark:bg-gray-900 border border-gray-500 rounded-lg p-10">
        ...
        <div className="flex flex-col items-center">
          ...
          <button className="bg-blue-500 text-white font-medium py-3 px-8 rounded-md w-full max-w-md flex items-center justify-center gap-2 mb-4 hover:bg-blue-600">
